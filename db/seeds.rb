...
require 'faker'
  ...
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby6)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby6)

  Diaper.create!(start_date: DateTime.now, category: "wet", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby5)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby5)

  Diaper.create!(start_date: DateTime.now, category: "wet", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby4)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby4)

  Diaper.create!(start_date: DateTime.now, category: "wet", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby3)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby3)

  Diaper.create!(start_date: DateTime.now, category: "wet", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby2)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby2)

  Diaper.create!(start_date: DateTime.now, category: "wet", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 2, category: "dry", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 4, category: "dirty", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 6, category: "OMG", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 8, category: "OMG", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 10, category: "clean", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 12, category: "OMG", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 14, category: "wet", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 16, category: "dirty", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 18, category: "clean", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 20, category: "dry", comment: "Baby clean!", baby: baby1)
  Diaper.create!(start_date: DateTime.now - 22, category: "wet", comment: "Baby clean!", baby: baby1)
