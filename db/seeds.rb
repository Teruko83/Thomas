...
require 'faker'
  ...
  Sleep.create!(start_date: DateTime.now - 2.9, sleep_time: 3, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 4.2, sleep_time: 8, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 6.5, sleep_time: 0.5, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 8.1, sleep_time: 2, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 10.4, sleep_time: 3, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 12.7, sleep_time: 5.5, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 14.2, sleep_time: 6, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 16.3, sleep_time: 1, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 18.5, sleep_time: 7, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 20.4, sleep_time: 7.5, baby: baby1, user: baby1.user)
  Sleep.create!(start_date: DateTime.now - 22.2, sleep_time: 3, baby: baby1, user: baby1.user)
  ...
  Sleep.create!(start_date: DateTime.now - 4.3, sleep_time: 8, baby: baby2, user: baby2.user)
  ...
  Sleep.create!(start_date: DateTime.now - 14.3, sleep_time: 6, baby: baby2, user: baby2.user)
  ...
  Sleep.create!(start_date: DateTime.now - 8.3, sleep_time: 2, baby: baby3, user: baby3.user)
  ...
  Sleep.create!(start_date: DateTime.now - 20.3, sleep_time: 7.5, baby: baby3, user: baby3.user)
